    ...
    <Dialog>
      <form>
        ...
        <DialogContent>
          ...
          <div>
            <FormInput type="text" name="title" label="Title" defaultValue={props.data?.title} />
            <FormInput type="text" name="thumbnail" label="Thumbnail"defaultValue={props.data?.thumbnail}/>
            <div id="category">
